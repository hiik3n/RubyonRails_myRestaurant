...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post food_items_url, params: { food_item: { descripion: @food_item.descripion, image_url: @food_item.image_url, name: @food_item.name, price: @food_item.price, section: @food_item.section } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { descripion: @food_item.descripion, image_url: @food_item.image_url, name: @food_item.name, price: @food_item.price, section: @food_item.section } }
